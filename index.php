...
<body class="bg-primary-subtle">
    <div id="app">
        ...
        <ul class="list-unstyled">
            <li v-for="(toDo, index) in toDoList" :key="index" class="border border-primary mb-2 p-2" :class="{ 'text-decoration-line-through' : toDo.done }" @click="toggleTaskDone(index)">
                {{toDo.text}}
            </li>
        </ul>
        </div>
